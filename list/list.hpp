...
public:
    ...
    private:
        ...
        const list<T>* id;
    public:
        explicit iterator(node* _pos = nullptr, const list<T>* _id = nullptr): pos(_pos), id(_id) {}
    ...
    private:
        ...
        const list<T>* id;
    public:
        explicit const_iterator(const node* _pos = nullptr, const list<T>* _id = nullptr): pos(_pos), id(_id) {}
